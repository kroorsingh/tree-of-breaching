...
export const CURATED_MODS: CuratedMod[] = [
  ...
  { id: 'max_chaos_res',      displayName: 'Maximum Chaos Resistance',              modType: 'suffix', tags: ['Chaos'],                                   repoeModId: 'MaximumChaosResist1' },
  ...
  { id: 'dot_multi',          displayName: 'Damage over Time Multiplier',           modType: 'suffix', tags: ['Chaos'],                                   repoeModId: 'GlobalDamageOverTimeMultiplier1h1' },
  ...
  { id: 'life_leech',         displayName: 'Life Leech from Physical Attacks',     modType: 'suffix', tags: ['Life', 'Attack'],                          repoeModId: 'LifeLeechPermyriadSuffix1' },
  ...
  { id: 'mana_leech',         displayName: 'Mana Leech from Physical Attacks',     modType: 'suffix', tags: ['Mana', 'Attack'],                          repoeModId: 'ManaLeechPermyriadSuffix1' },
  ...
  { id: 'phys_reduction',     displayName: 'Physical Damage Reduction %',          modType: 'suffix', tags: ['Defense', 'Physical'],                     repoeModId: 'AdditionalPhysicalDamageReduction1' },
  ...
  { id: 'avoid_ailments',     displayName: 'Avoid Elemental Ailments %',           modType: 'suffix', tags: ['Defense'],                                 repoeModId: 'ChanceToAvoidElementalStatusAilments1' },

  // Reduced crit damage taken — str shields (Armour/Armour+Ev/Armour+ES)
  { id: 'reduce_crit_dmg',    displayName: 'Reduced Extra Damage from Crits',      modType: 'suffix', tags: ['Defense', 'Critical'],                     repoeModId: 'ReducedExtraDamageFromCrits1___' },

  // Reduced attribute requirements — armour/shield slots
  { id: 'reduce_attr_reqs',   displayName: 'Reduced Attribute Requirements',       modType: 'suffix', tags: ['Attributes'],                              repoeModId: 'ReducedLocalAttributeRequirements1' },
  ...
  { id: 'stun_duration',      displayName: 'Stun Duration on Enemies',             modType: 'suffix', tags: ['Defense'],                                 repoeModId: 'StunDuration1' },
];
